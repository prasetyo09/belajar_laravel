                    ...
                    <form action="{{ route('role.update', $roles->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_active" id="is_active1" {{ $roles->is_active == 1 ? 'checked' : '' }} value="1">
                                <label class="form-check-label" for="is_active">
                                    Active
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_active" id="is_active2" {{ $roles->is_active == 0 ? 'checked' : '' }} value="0">
                                <label class="form-check-label" for="is_active">
                                    Non-Active
                                </label>
                            </div>
